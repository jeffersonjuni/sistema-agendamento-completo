...
<div class="space-y-6">
    ...
    <x-ui.page-header
        ...
        subtitle="Atualize o expediente do dia selecionado."
    />
        ...
        >
            ...
            <div>
                ...
                >
                    ...
                    <option
                        value="1"
                        @selected(old('is_open', $schedule->is_open) == 1)
                    >
                        Aberto
                    </option>
                    ...
                    <option
                        value="0"
                        @selected(old('is_open', $schedule->is_open) == 0)
                    >
                        Fechado
                    </option>
            ...
            () => {
                ...
                if (status.value === '0') {
                    ...
                    Swal.fire({
                        ...
                        text: "Este dia ficará indisponível para novos agendamentos.",
